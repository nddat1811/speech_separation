...
for n_src in 2; do      # for n_src in 2, 3; do
  metadata_dir=metadata/Libri$n_src"Mix"
  echo "wham_dir into $wham_dir"
  echo "metadata_dir into $metadata_dir"
  echo "librimix_outdir into $librimix_outdir"
  echo "librispeech_dir into $librispeech_dir"
